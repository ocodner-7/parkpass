    ...
    const { error: balanceError } = await supabase
      ...
      .update({
        ...
        quota_used_this_month:
          household.quota_used_this_month + selectedDuration!,
      })
      .eq("id", membership.household_id);
        ...
        <div className="px-6 py-5 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-sm font-medium text-content-secondary">Vehicle</p>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-sm font-medium text-content-secondary">Start time</p>
            </div>
            <div className="flex gap-2 mb-3">
              <button
        ...
        <div className="px-6 py-4 border-t border-border-default-subtle flex items-center justify-between bg-surface-secondary">
          <div>
            {finalRegistration && selectedDuration ? (
              ...
              <p className="text-xs text-content-muted">Fill in the details above</p>
            )}
          </div>
          <button
